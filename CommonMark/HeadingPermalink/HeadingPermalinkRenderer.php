...
namespace peerj\MarkdownBundle\CommonMark\HeadingPermalink;
...
final class HeadingPermalinkRenderer implements InlineRendererInterface, ConfigurationAwareInterface
{
    ...
    public function render(AbstractInline $inline, ElementRendererInterface $htmlRenderer)
    {
        ...
        $attrs = [
            'id'          =>  $slug, // the id prefix is set by htmlpurifier in MarkdownConverter.php
            'href'        => '#' . $idPrefix . $slug,
            //'name'        => $idPrefix . $slug, // name is no longer a valid anchor attribute in HTML5
